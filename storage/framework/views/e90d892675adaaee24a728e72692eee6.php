...
<body>
    ...
    <main class="recipe-content">
        ...
        <div class="recipe-image-container">
            <img src="<?php echo e($image); ?>" alt="Delicious Recipe" class="recipe-img">
        </div>

        <div class="recipe-header">
        <h1><p><?php echo e($recipe->recipe_name); ?></p></h1>
    ...
    <i class="fas fa-heart" id="heart-icon"></i>
        ...
        <!-- Recipe Description -->
        <p class="description">
            <?php echo e($recipe->recipe_description); ?>
        ...
        <div class="details-container">
            ...
            <div class="ingredients">
                <h2>Ingredients</h2>
                <p><?php echo nl2br(e($recipe->recipe_ingredients)); ?></p>
            </div>

            <!-- Instructions Section -->
            <div class="instructions">
                <h2>Instructions</h2>
                <p><?php echo nl2br(e($recipe->recipe_instructions)); ?></p>
            </div>
        </div>
